...
class InventoryNewItemsViewModel with ChangeNotifier {
  // Variables
  ...
  Future<List<CategoriesModel>> fetchCategories() async {
    try {
      final response = await http.get(Uri.parse(AppUrls.getInventory(
          warehouseName: 'Alpha Warehouse', isNewProducts: true.toString())));
  ...
  Future<List<ProductModel>> fetchProducts() async {
    try {
      final response = await http.get(Uri.parse(AppUrls.getInventoryNewItems(
