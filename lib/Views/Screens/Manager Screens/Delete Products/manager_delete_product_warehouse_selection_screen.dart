...
class ManagerDeleteProductWarehouseSelectionScreen extends StatefulWidget {
  const ManagerDeleteProductWarehouseSelectionScreen({super.key});

  @override
  State<ManagerDeleteProductWarehouseSelectionScreen> createState() =>
      _ManagerDeleteProductWarehouseSelectionScreenState();
}

class _ManagerDeleteProductWarehouseSelectionScreenState
