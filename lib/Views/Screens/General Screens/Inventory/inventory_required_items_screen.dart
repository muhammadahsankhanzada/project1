...
class InventoryRequiredItemsScreen extends StatefulWidget {
  final categoryName;
  final int categoryindex;
  const InventoryRequiredItemsScreen({
    super.key,
  ...
  @override
  State<InventoryRequiredItemsScreen> createState() =>
      _InventoryRequiredItemsScreenState();
}

class _InventoryRequiredItemsScreenState
    extends State<InventoryRequiredItemsScreen> {
  @override
  void initState() {
    super.initState();
    final viewModel =
        Provider.of<InventoryRequiredItemsViewModel>(context, listen: false);
  ...
  Widget _buildShowCategories() {
    return FutureBuilderHelperWidget<List<CategoriesModel>>(
      future: context.read<InventoryRequiredItemsViewModel>().fetchCategories(),
      onSuccess: (categories) {
        return Consumer<InventoryRequiredItemsViewModel>(
