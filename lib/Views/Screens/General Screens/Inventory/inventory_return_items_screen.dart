...
class InventoryReturnItemsScreen extends StatefulWidget {
  final String categoryName;
  final int categoryIndex;
  const InventoryReturnItemsScreen({
    super.key,
  ...
  @override
  State<InventoryReturnItemsScreen> createState() =>
      _InventoryReturnItemsScreenState();
}

class _InventoryReturnItemsScreenState
    extends State<InventoryReturnItemsScreen> {
  @override
  void initState() {
    super.initState();
    final viewModel =
        Provider.of<InventoryReturnItemsViewModel>(context, listen: false);
  ...
  Widget _buildShowCategories() {
    return FutureBuilderHelperWidget<List<CategoriesModel>>(
      future: context.read<InventoryReturnItemsViewModel>().fetchCategories(),
