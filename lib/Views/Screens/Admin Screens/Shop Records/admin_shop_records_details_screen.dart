...
class _AdminShopRecordsDetailsScreenState
        ...
        child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                var shop = snapshot.data?.data() as Map<String, dynamic>?;
  ...
  Stream<DocumentSnapshot> fetchShopRecords() {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    final data = firestore.collection('Shops').doc(widget.shopName).snapshots();
    return data;
  }
}
